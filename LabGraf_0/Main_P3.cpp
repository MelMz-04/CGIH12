...
int main() {
	...
	//GLfloat vertices[] = {//proyección ortogonal
 ...
 //     
	...
	float vertices[] = {//proyección en perspectiva
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   view = glm::translate(view, glm::vec3(0.0f,0.0f,-10.0f));
		...
		//Segundo
		model = glm::mat4(1.0f);
		model = glm::translate(view, glm::vec3(-8.0f, 0.0f, -10.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(1.0f, 6.0f, 2.0f)); 
		model = glm::scale(model, glm::vec3(1.0f, 5.0f, 9.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		//Tercero
		model = glm::mat4(1.0f);
		model = glm::translate(view, glm::vec3(9.0f, 0.0f, -10.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(6.0f, 2.0f, 7.0f));
		model = glm::scale(model, glm::vec3(10.0f, 3.0f, 4.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
